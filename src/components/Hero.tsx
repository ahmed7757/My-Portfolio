        ...
        <div className="border-b border-neutral-950 pb-4 lg:mb-35">
            <div className="flex flex-wrap justify-between">
                <div className="w-full lg:w-1/2">
                    <div className="flex flex-col items-center text-neutral dark:text-current lg:items-start min-[320px]:items-start">
                        <motion.h1
                ...
                <div className="w-full lg:w-1/2">
                    <div className="flex md:justify-end justify-center">
                        <motion.img
                            ...
                            src={profilePic}
                            className="rounded w-96 h-auto shadow-md shadow-primary-content"
                            alt="Ahmed Gomaa" />
                    </div>
                </div>
            </div>
